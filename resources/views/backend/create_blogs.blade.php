                    ...
                    <form action="/blogs" method="post" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul') }}" id="judul" placeholder="Title blogs" autofocus>
                            @error('judul')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" id="slug" placeholder="Slug">
                            @error('slug')
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="hidden" name="content" value="{{ old('content') }}" id="content">
                            <trix-editor input="content"></trix-editor>
                        </div>
                        <div class="form-group">
                            <label for="tags">Tags</label>
                            <select class="select2 @error('tags') is-invalid @enderror" name="tags[]" multiple="multiple" data-placeholder="Select a Tags" style="width: 100%">
                              @foreach($tags as $tag)
